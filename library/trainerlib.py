...
class Trainer:
    ...
    def train_one_epoch(
        ...
        distributed = False # True if conf["trainer"]["mode"] in ["fsdp", "ddp"] else False
        ...
        for steps in range(batches_per_epoch):
            ...
            # agg the results
            to_print = "Epoch (train): {} loss: {:.6f}".format(
                epoch,
    ...
    def validate(
        ...
        with torch.no_grad():
            for k, (x,label_data) in enumerate(valid_loader):
                ...
                for key, _loss in zip(["loss",], [loss,]):
                ...
                # agg the results
                to_print = "Epoch (valid): {} loss: {:.6f}".format(
                    epoch,
    ...
    def fit(
        ...
        start_epoch = 0 # conf['trainer']['start_epoch']
